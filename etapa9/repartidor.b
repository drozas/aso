			...
			if (es!=nil)
			{
				...
				pick r := peticionUnpack {
					...
					Get =>
						...
						#En este bucle se detectaran nuevos servidores caidos
						do
						{
...
init(nil: ref Draw->Context, argv: list of string)
{
	...
	#Y el canal de gestion de conexiones
	...
	#Creamos el thread que gestiona el n_conexiones
	...
	for(;;)
	{
		sys->print("Esperando por clientes...\n");
